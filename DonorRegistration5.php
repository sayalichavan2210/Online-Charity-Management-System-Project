...
if(isset($_POST['submit'])){
    ...
    $sql = "INSERT INTO `doner_registratration5`(`sr_no`,`name`, `email`, `phoneno`, `address`, `Password`, `date` ) 
    ...
    if($connection->query($sql) === TRUE) {
        ...
        try {
            ...
            $mail->send();
            echo '<script>alert("Registration successful. Email sent."); window.location.href = "Payment5.php";</script>';
        } catch (Exception $e) {
...
<body>
	<div class="container">
		<form action="./DonorRegistration5.php" method="post">
