...
<body>
	<div class="container">
		<form action="./DonorRegistration4.php" method="post">
...
if(isset($_POST['submit'])){
    ...
    $sql = "INSERT INTO `doner_registratration4`(`sr_no`,`name`, `email`, `phoneno`, `address`, `Password`, `date`) 
    ...
    if($connection->query($sql) === TRUE) {
        ...
        try {
            ...
            $mail->send();
            echo '<script>alert("Registration successful. Email sent."); window.location.href = "Payment4.php";</script>';
        } catch (Exception $e) {
            echo '<script>alert("Registration successful. Email could not be sent.")</script>';
        }
    } else {
