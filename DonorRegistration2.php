...
<body>
	<div class="container">
		<form action="./DonorRegistration2.php" method="post">
...
if(isset($_POST['submit'])){
    ...
    $sql = "INSERT INTO `doner_registratration2`(`sr_no`,`name`, `email`, `phoneno`, `address`, `Password`, `date`) 
    ...
    if($connection->query($sql) === TRUE) {
        ...
        try {
            ...
            $mail->send();
            echo '<script>alert("Registration successful. Email sent."); window.location.href = "Payment2.php";</script>';
        } catch (Exception $e) {
