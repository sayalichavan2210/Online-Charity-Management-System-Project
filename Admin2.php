...
function calculateTotalDonations($connection) {
    $query = "SELECT SUM(donation_amount) AS total_amount FROM payment1";
...
if (isset($_GET['show_all'])) {
    $sql = "SELECT t1.sr_no AS sr_no, t1.user_name, t1.email, t1.phoneno, t1.address, t1.date,
    ...
    if (isset($_GET['name'])) {
        ...
        FROM doner_registratration1 t1
        INNER JOIN payment1 t2 ON t1.phoneno = t2.phoneno
        WHERE t1.user_name LIKE '%$search_name%'";
    }
}
