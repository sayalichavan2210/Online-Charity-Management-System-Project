...
if(isset($_POST['submit'])){
    ...
    $phoneno = preg_match('/^\d{10}$/', $phoneno) ? $phoneno : false;
    ...
    $sql = "INSERT INTO `doner_registratration1`(`user_name`, `email`, `phoneno`, `address`, `Password`, `date`) 
            VALUES ('$name','$email','$phoneno','$address','$password','$date')";

    if($connection->query($sql) === TRUE) {
        $_SESSION['phoneno'] = $phoneno; // Store phone number for validation in Payment1.php
        echo '<script>alert("Registration Successful!"); window.location.href = "Payment.php";</script>';
    } else {
