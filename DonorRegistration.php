...
if(isset($_POST['submit'])){
    ...
    $phoneno = preg_match('/^\d{10}$/', $_POST['phoneno']) ? $_POST['phoneno'] : false;
    ...
    $sql = "INSERT INTO `doner_registration`(`sr_no`,`name`, `email`, `phoneno`, `address`, `Password`, `date`) 
    ...
    if($connection->query($sql) === TRUE) {
        ...
        try {
            ...
            $mail->send();
            echo '<script>alert("Registration successful. Email sent."); window.location.href = "Payment.php";</script>';
        } catch (Exception $e) {
            echo '<script>alert("Registration successful. Email could not be sent.") window.location.href = "Payment.php";</script>';
        }
    } else {
